...
export const updateIssue = async (id, issueData) => {
  try {
    ...
    // Use "issue_id" in the endpoint URL rather than "id"
    ...
    if (issueData instanceof FormData) {
      ...
      if (Object.prototype.hasOwnProperty.call(payload, 'assignee')) {
        // Ensure assignee is properly formatted (null vs empty string)
        console.log('Assignee update detected. Original value:', payload.assignee);
      }
